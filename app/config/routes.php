...
*/
$route['default_controller'] = 'welcomer';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
$route['(:any)/(:any)/(:any)/(:any)/(:any)'] = 'doctor/$1/$2/$3/$4/$5';
$route['(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'doctor/$1/$2/$3/$4/$5/$6';
$route['(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'doctor/$1/$2/$3/$4/$5/$6/$7';
$route['(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'doctor/$1/$2/$3/$4/$5/$6/$7/$8';
$route['(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'doctor/$1/$2/$3/$4/$5/$6/$7/$8/$9';
