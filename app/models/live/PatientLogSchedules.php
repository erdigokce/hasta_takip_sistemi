...
class Patientlogschedules extends HTS_Model implements IPatientLogSchedulesModel {
  ...
  public function findAllWithFullDeviceSocket() {
    $this->setQuery($this->db->query("SELECT d.DEVICE_HOST, d.DEVICE_PORT, l.* FROM ".HTS_LIVE.".hts_patient_tracking_devices d, ".HTS_LIVE.".hts_log_schedules l WHERE d.ID = l.DEVICE_ID ORDER BY d.DEVICE_HOST;"));
